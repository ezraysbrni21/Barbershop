...
<header>
    ...
    <center><h1>Recruitment</h1></center>
    <br/>
    <table>
      <thead>
        <tr>
    ...
    <tbody>
      ...
      $query = "SELECT * FROM informasi ORDER BY pekerjaan ASC";
      ...
      ?>
       <tr>
          ...
          <td><?php echo substr($row['deskripsi_pekerjaan'], 0, 20); ?></td>
          ...
          <td>
              <button><a href="edit.php?id=<?php echo $row['pekerjaan']; ?>">Edit</a></button> |
              <button ><a href="delete.php?id=<?php echo $row['pekerjaan']; ?>" onclick="return confirm('Anda yakin akan menghapus informasi ini?')">Hapus</a></button>
          </td>
      </tr>
