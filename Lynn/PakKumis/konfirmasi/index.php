...
<html>
  ...
  <body>
    ...
    <center><h1>Konfirmasi Appointment</h1><center>
    <br/>
    <table>
      <thead>
        <tr>
    ...
    <tbody>
      ...
      $query = "SELECT * FROM konfirmasi ORDER BY id ASC";
      ...
      ?>
       <tr>
          ...
          <td><?php echo substr($row['tanggal_waktu'], 0, 20); ?></td>
          <td><?php echo $row['layanan'] ?></td>
         
          <td>
              <button><a href="Terima.php?id=<?php echo $row['id']; ?>">Terima</a></button> |
              <button ><a href="Batal.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan membatalkan ini?')">Batal</a></button>
          </td>
      </tr>
